...
if __name__ == "__main__":
    ...
    parser.add_argument("--consistency", action="store_true", help="Run consistency verification")
    ...
    parser.add_argument("-c", "--checkpoint", action="store_true", help="Fetch latest checkpoint")
    ...
    if args.inclusion and args.artifact:
        ...
        if not args.tree_id or not args.tree_size or not args.root_hash:
            print("Error: --tree-id, --tree-size, and --root-hash are required for consistency check.")
        else:
        ...
        print("Usage:")
        print("  --inclusion <logIndex|UUID> --artifact <path>       Verify inclusion")
        print("  --consistency --tree-id <id> --tree-size <size> --root-hash <hex>  Verify consistency")
        print("  -c or --checkpoint                                    Fetch latest checkpoint")